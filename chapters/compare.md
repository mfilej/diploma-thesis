...
Ena izmed težav pri učenju predmeta digitalna forenzika je priprava nalog za študente. Le-te se študentom dodelijo v obliki zgodbe, ki opisuje kriminalno dejanje, in slike diska, ki predstavlja evidenco primera. Goljufanje (prepisovanje) znotraj večjih skupin študentov pri reševanju nalog, bi lahko preprečili tako, da bi vsakemu študentu dodelili individualizirano nalogo. Da bi lahko dosegli avtomatizirano tvorjenje novih nalog, bi potrebovali dovolj velik korpus, da bi na podlagi le-tega lahko izvedli učenje NLG sistema. Nabor podatkov takšne velikosti namreč ni prosto na voljo.
